...
typedef std::complex<float>  fcomplexT;      // Fortran complex type   COMPLEX*8
typedef std::complex<double> dcomplexT;      // Fortran complex type   COMPLEX*16
//typedef struct { double r,i; } dcomplexT;
//typedef struct { float r,i; }  fcomplexT;
