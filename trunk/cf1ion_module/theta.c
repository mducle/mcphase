...
s="U ";a=x*alpha_J[15];b=y*beta_J[15];c=z*gamma_J[15];fprintf(fp,text,s,a,b,c);
...
info_rn()          /* Liste der <r > n=2,4,6 ausgeben */
{
    ...
    s="U ";a=r2[15];b=r4[15];c=r6[15];fprintf(fp,texti ,s,a,b,c);
    fprintf(fp,"\n");
    fprintf(fp,"-----------------------------------------------------------\n");
    ...
    s="U ";a=r2[15]*a2;b=r4[15]*a4;c=r6[15]*a6;fprintf(fp,sexti ,s,a,b,c);
    fprintf(fp,"\n");
    fprintf(fp,"-----------------------------------------------------------\n");
    fprintf(fp,"|                 2                 4                  6  |\n");
