...
\emph{Wybourne}. Stevens~\cite{stevens52-209} initially expressed the radial parts of the crystal field interaction
...
In summary, the various types of crystal field parameters understood by {\prg McPhase} are:
...
parameters for rare earths, you should set the Slater {\prg F2, F4, F6} and spin-orbit {\prg xi} integrals to
