...
\hline
int dP1 & & {\prg mcdisp} & phonon displacement (\AA) $\langle-|\hat \mbf P|+\rangle=\frac{\hbar}{\sqrt{2m\Delta}}$\\
\hline
...
the external single ion module has to provide the transition matrix elements of
 the phonon displacement $p_{\alpha}$ in units of \AA, which is usually given by:
$\langle-|\hat \mbf P_{\alpha}|+\rangle=\frac{\hbar}{\sqrt{2m\Delta_{\alpha}}}$,
...
\item for the transition number tn the vector p1 is to
 ...
 $\langle-|\hat \mbf P_{\alpha}|+\rangle=\frac{\hbar}{\sqrt{2m\Delta_{\alpha}}}$ (equally spaced
Einstein oscillator)
or more general
