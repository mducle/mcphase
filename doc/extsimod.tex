...
%*************************************************************************************
\subsection{External module function {\prg Icalc} - used by {\prg mcphas},{\prg singleion\index{singleion}},{\prg %%@
...
%\item if a negative value for T is entered, the vector u1 is to be filled with
...
extern "C" double ro_calc(double & teta,double & fi,double &R,Vector &aLlm, double *T,
     Vector &gjmbHxc,Vector & Hext, double *gJ,Vector &MODPAR,char **sipffilename);
\end{verbatim}
