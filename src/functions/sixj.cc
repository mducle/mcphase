/*-----------------------------------------------------------------------------*\
| Matpack special functions - SixJSymbol() - Wigner 6j symbols          sixj.cc |
|                                                                               |
| Last change: June 14, 1997							|
|                                                                               |
		 ...
		 double *sixcof, int ndim, int &errflag)
{
  ...
  double c1old, sign1, sign2, x, y, denom, cnorm, ratio, 
         a1, a2, c1, c2, l1, x1, x2, x3, y1, y2, y3, oldfac, dv, newfac, 
         sumbac, thresh, a1s, a2s, sumfor, sumuni, sum1, sum2;
  ...
  // Limits for l1 
  l1min = MpMax(abs(l2-l3),abs(l5-l6));
