...
PRINT "FIT1GAUS FIT1GAUS FIT1GAUS FIT1GAUS FIT1GAUS FIT1GAUS FIT1GAUS FIT1GAUS FIT1GAUS FIT1GAUS"
IF LTRIM$(COMMAND$) = "" GOTO 333
DATA "*************************************************************************"
DATA "  program FIT1GAUS - use it like FIT1GAUS *.* 23"
DATA "    (23 means calc.1-lineGAUSfit of 3rd columns with respect to second column) - "
DATA " ---> the result is written in file *.*,    /G..... view graphics when fitting  "
DATA " the gauss fit  is calculated by least squares method              "
...
SHELL "copy FIT1GAUS.lin " + filename$
SHELL "del FIT1GAUS.lin"
PRINT
PRINT "END FIT1GAUS in file "; filename$;
PRINT " column"; jj%; "FIT1GAUS calc. with respect to column"; ii%;
