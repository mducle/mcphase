...
public class PostscriptViewer extends JApplet implements ActionListener, Runnable {
    ...
    public void init(String s[]) {
        ...
        PostscriptFiles = new String[s.length];
        for (int i = 0; i < s.length; i++) {
            combo.addItem(s[i]);
              PostscriptFiles[i]=s[i];
                    }
...
//        url = PostscriptViewer.class.getResource(PostscriptFiles[0]);
          url=PostscriptFiles[0];
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() instanceof JButton) {
            ...
            url = (String) PostscriptViewer.combo.getSelectedItem();
//            System.out.println(str);
            //url = Demo.class.getResource(str);
        }
...
//                InputStream inputStream = url.openStream();
	...
	Frame f = new Frame("Postscript Viewer");
