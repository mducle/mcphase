/***********************************************************
 *
 * momdensplt - program to display moment density of
...
printf("***********************************************************\n");
printf("*\n");
printf("* momdensplt - program to display moment density of \n");
...
// check command line
  if (argc < 7)
    { printf ("\nprogram momdensplt - calculate moment density of a single ion\n\n\
		...
		\n");
      printf ("\n\
...to view momdensityplots type: javaview results/momdensplt.jvx\n\
                                  displaycontour 2 3 4 results/momdensplti.grid\n\
                                  displaycontour 1 3 4 results/momdenspltj.grid\n\
                                  displaycontour 1 2 4 results/momdenspltk.grid\n\
                \n");
      exit (1);
    }
...
if(xx!=0||doijk<3)jjjps.spindensity_coeff (momentsx,1, T, h,Hext, jjjps.Icalc_parstorage);
...
fprintf(stderr,"# * javaview results/momdensplt.jvx\n");
